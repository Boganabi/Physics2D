...
public class RealisticRope : MonoBehaviour
{

    // objects that interact with rope
    public Transform ropeConnection;
    public Transform ropeHangingObject;
    ...
    void Start()
    {
        ...
        Vector3 pos = ropeConnection.position;
    ...
    private void UpdateRopeSimulation(List<RopeSection> allRopeSections, float timeStep)
    {
        ...
        lastRopeSection.pos = ropeConnection.position;
